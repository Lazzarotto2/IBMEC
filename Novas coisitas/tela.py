...
class Tela:
    ...
    def personagem(self, personagem, cor=CORES.branco):
        texto = self.fonte_gde.render(personagem.char, True, personagem.cor) #Mudei a variavel para personagem.cor para coseguir mudar a cor do tesouro (Agr da pra mudar ate a do npc)
        self.display.blit(
            texto,
